...
func _ready() -> void:
	...
	growth_cycle_component.crop_maturity.connect(on_tomato_maturity)
	growth_cycle_component.crop_harvesting.connect(on_tomato_harvesting)
...
func on_tomato_maturity() -> void:
	flowering_particles.emitting = true

func on_tomato_harvesting() -> void:
